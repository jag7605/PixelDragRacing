...
export default class GarageScene extends Phaser.Scene {
  ...
  showDetail(car) {
    ...
    // (Optional) Select button – store choice for later use in RaceScene
    ...
    select.on('pointerdown', () => {
      this.registry.set('selectedCar', car.key); // save choice
      // You can jump directly to the race if you want:
      // this.scene.start('RaceScene');
      this.buildGallery(); // for now, return to gallery
    });
